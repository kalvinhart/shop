...
export const useAuthForm = (inputConfig: InputConfig, formSubmit: (formValues: InputConfig) => void) => {
  ...
  const handleChange = (e: React.SyntheticEvent) => {
    ...
    setFormValues({
      ...
      [(e.target as HTMLInputElement).name]: {
        ...
        options: { ...formValues[(e.target as HTMLInputElement).name as keyof InputConfig]!.options },
      },
    });
  };
